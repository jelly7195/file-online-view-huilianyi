...
public class ConfigConstants {
    ...
    private static String[] trustHosts;
    ...
    public void setTrustHost(String trustHost) {
        ...
        setTrustHosts(getHostValueArray(trustHost));
    }
    ...
    private static String[] getHostValueArray(String trustHost) {
        String[] trustHosts;
        if (DEFAULT_VALUE.equalsIgnoreCase(trustHost)) {
            return new String[]{};
        } else {
            return trustHost.toLowerCase().split(",");
        }
    }
    ...
    public static String[] getTrustHosts() {
        return trustHosts;
    }

    public static void setTrustHosts(String[] trustHosts) {
        ConfigConstants.trustHosts = trustHosts;
    }
