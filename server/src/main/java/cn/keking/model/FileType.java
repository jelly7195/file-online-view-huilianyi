...
public enum FileType {
    ...
    private static final String[] CODES = {"java", "c", "php", "go", "python", "py", "js", "ftl", "css", "lua", "sh", "rb", "yaml", "yml", "json", "h", "cpp", "cs", "aspx", "jsp", "sql"};
    ...
    static {
        ...
        FILE_TYPE_MAPPER.put("html",FileType.HTML);
        FILE_TYPE_MAPPER.put("xlsx", FileType.Excel);
        FILE_TYPE_MAPPER.put("xls", FileType.Excel);
    }
