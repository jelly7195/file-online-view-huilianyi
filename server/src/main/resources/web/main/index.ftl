...
<nav class="navbar navbar-dark bg-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="" target=''>预览</a>
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="./index">首页</a>
            </li>
            <#--                <li class="nav-item"><a class="nav-link" href="./integrated">接入说明</a></li>-->
            <#--                <li class="nav-item"><a class="nav-link" href="./record">版本发布记录</a></li>-->
            <#--                <li class="nav-item"><a class="nav-link" href="./sponsor">赞助开源</a></li>-->
        </ul>
    </div>
</nav>
...
<div class="container theme-showcase" role="main">
    <div class="container theme-showcase" role="main">
        ...
        <div class="card border-info">
            <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                ...
                <small><i class="fas fa-clock mr-1"></i>${.now?string('yyyy-MM-dd HH:mm')}</small>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="d-flex align-items-center mb-2">
                            <span class="badge badge-primary mr-2">版本</span>
                            <span class="font-weight-bold">v20251205</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div>
            <ol>
                <li>支持 doc, docx, xls, xlsx, xlsm, ppt, pptx, csv, tsv, dotm, xlt, xltm, dot, dotx, xlam, xla, pages 等
                    Office 办公文档
                </li>
                ...
                <li>支持 eml 邮件文件</li>
                <li>支持 epub 图书文档</li>
                <li>支持 obj, 3ds, stl, ply, gltf, glb, off, 3dm, fbx, dae, wrl, 3mf, ifc, brep, step, iges, fcstd, bim
                    等 3D 模型文件
                </li>
        ...
        <div class="card border-success mb-3">
            <div class="card-header bg-success text-white">
                <h5 class="card-title mb-0">输入下载地址预览</h5>
            </div>
            <div class="card-body">
                <form>
                    <div class="form-row">
                        ...
                        <div class="col-md-2 mb-2">
                            <button id="previewByUrl" type="button" class="btn btn-success btn-block">预览</button>
                        </div>
                    </div>

                    <div class="alert alert-danger alert-dismissible fade hide" role="alert" id="previewCheckAlert">
        ...
        <div class="card border-success mb-3">
            <div class="card-header bg-success text-white">
                <h5 class="card-title mb-0">上传本地文件预览</h5>
            </div>
            <div class="card-body">
                        ...
                        <div class="form-row align-items-center">
                            <div class="col-md-8 mb-2">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="file">请选择文件</label>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <button id="fileUploadBtn" type="button" class="btn btn-success btn-block">上传</button>
                            </div>
                        </div>
                    </form>
                </#if>
    ...
    <script type="application/javascript">
        ...
        $(document).ready(function () {
            ...
            // 修复警告框显示逻辑
            $("#previewCheckAlert").on('close.bs.alert', function () {
        ...
        $(function () {
            $('#table').bootstrapTable({
                ...
                classes: 'table table-striped table-bordered table-hover',// 添加Bootstrap 4.x表格样式
                columns: [{
                    field: 'fileName',
                    title: '文件名'
                }, {
                ...
                $(data).each(function (index, item) {
                    item.action = "<a class='btn btn-success btn-sm' target='_blank' href='${baseUrl}onlinePreview?url=" + encodeURIComponent(Base64.encode('${baseUrl}' + item.fileName)) + "'>预览</a>";
